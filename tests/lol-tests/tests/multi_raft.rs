...
async fn N3_L1000_K3_multi_raft_cluster() -> Result<()> {
    const L: u32 = 1000;
...
#[serial]
#[tokio::test(flavor = "multi_thread")]
async fn N3_L1000_K3_multi_raft_io_roundrobin() -> Result<()> {
    const L: u32 = 1000;
...
#[serial]
#[tokio::test(flavor = "multi_thread")]
async fn N1_L1000_K3_multi_raft_io() -> Result<()> {
    const L: u32 = 1000;
...
#[serial]
#[tokio::test(flavor = "multi_thread")]
async fn N3_L1000_K3_multi_raft_io() -> Result<()> {
    const L: u32 = 1000;
