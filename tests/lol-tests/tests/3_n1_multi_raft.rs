...
async fn N1_L10_multi_raft_io() -> Result<()> {
    const P: u32 = 10;
...
#[serial]
#[tokio::test(flavor = "multi_thread")]
async fn N3_L10_multi_raft_cluster() -> Result<()> {
    const P: u32 = 10;
...
#[serial]
#[tokio::test(flavor = "multi_thread")]
async fn N3_L10_multi_raft_io() -> Result<()> {
    const L: u32 = 100;
...
#[serial]
#[tokio::test(flavor = "multi_thread")]
async fn N3_L10_multi_raft_io_roundrobin() -> Result<()> {
    const P: u32 = 10;
